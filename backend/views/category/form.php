    ...
    <div class="col-md-6">
      <div class="card">
        <div class="card-body">
          ...
          <h3 class="mt-2 mb-3"><?= $model->getIsNewRecord() ? 'Create Category' : 'Update Category' ?></h3>
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                <?= $form->field($model, 'main_category_id')->dropDownList((new MainCategory())->get(), ['prompt' => 'Please select a Category', 'class' => 'select2 form-control']); ?>
              </div>
              <div class="form-group">
