...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="/backend/web/css/jquery.fileupload.css" />
    <link rel="stylesheet" href="/backend/web/css/jquery.fileupload-ui.css" />
    <!-- CSS adjustments for browsers with JavaScript disabled -->
    <noscript
      ><link rel="stylesheet" href="/backend/web/css/jquery.fileupload-noscript.css"
    /></noscript>
    <noscript
      ><link rel="stylesheet" href="/backend/web/css/jquery.fileupload-ui-noscript.css"
    /></noscript>
  </head>
  <body>
    <div class="container">
    ...
    <script src="/backend/web/js/vendor/jquery.ui.widget.js"></script>
    ...
    <script src="/backend/web/js/jquery.iframe-transport.js"></script>
    <!-- The basic File Upload plugin -->
    <script src="/backend/web/js/jquery.fileupload.js"></script>
    <!-- The File Upload processing plugin -->
    <script src="/backend/web/js/jquery.fileupload-process.js"></script>
    <!-- The File Upload image preview & resize plugin -->
    <script src="/backend/web/js/jquery.fileupload-image.js"></script>
    <!-- The File Upload audio preview plugin -->
    <script src="/backend/web/js/jquery.fileupload-audio.js"></script>
    <!-- The File Upload video preview plugin -->
    <script src="/backend/web/js/jquery.fileupload-video.js"></script>
    <!-- The File Upload validation plugin -->
    <script src="/backend/web/js/jquery.fileupload-validate.js"></script>
    <!-- The File Upload user interface plugin -->
    <script src="/backend/web/js/jquery.fileupload-ui.js"></script>
    <!-- The main application script -->
    <script src="/backend/web/js/demo.js"></script>
